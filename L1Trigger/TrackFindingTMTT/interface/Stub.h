...
namespace TMTT {
 ...
 class Stub : public TTStubRef {
  ...
  private:
   ...
   void check2() const {if (digitizeWarningsOn_ && digitizedForHTinput_ && !settings_->tracklet()) throw cms::Exception("Stub: You can't access digitized dphi within the HT or KF!");}
